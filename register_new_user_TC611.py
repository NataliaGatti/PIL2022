...
closeModal = driver.find_element(By.CLASS_NAME, "vtex-modal-layout-0-x-closeButton")
closeModal.click()

#Entrar al avatar del login/register en la navbar
avatar = driver.find_element(By.XPATH, "/html/body/div[2]/div/div[1]/div/div[1]/div/div[2]/div/div/section/div/div/section/div/div[3]/div/div/div/div/div[5]/div/div/button")
avatar.click()
time.sleep(2)

#Validar presencia, texto y redireccionamiento del link "Volver"
loginButton = driver.find_element(By.XPATH, "/html/body/div[5]/div/div/div/div/div/div[2]/div/div/div/div[1]/ul/li[2]/div/button")
loginButton.click()
time.sleep(2)
link = driver.find_element(By.LINK_TEXT, "¿No tiene una cuenta? Regístrese")
link.click()
time.sleep(2)
volver = driver.find_element(By.XPATH, "/html/body/div[5]/div/div/div/div/div/div[2]/div/div/div/div/form/div[2]/div[1]/button")
...
email.send_keys("nataliagatti15hotmail.com")
time.sleep(2)

# Validar presencia del botón "Enviar" y que su texto sea "Enviar"
enviarButton = driver.find_element(By.XPATH, "/html/body/div[5]/div/div/div/div/div/div[2]/div/div/div/div/form/div[2]/div[2]/button")
...
# Validar que el email ingresado es inválido y que no permita avanzar en la creación del nuevo usuario mostrando el error correspondiente
try:
